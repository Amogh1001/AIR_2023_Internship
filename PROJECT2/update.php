...
$user[0]["date"] = date("Y-m-d H:i:s");
echo $rest->update($token, $user[0]["name"], $user[0]["mobile_number"], $user[0]["email"], $user[0]["address"], $user[0]["login_name"], $user[0]["password"], $user[0]["date"]);
